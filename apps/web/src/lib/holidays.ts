...
export type Religion = "christian" | "muslim" | "other";
...
export function ethiopianHolidaysForDate(eth: EthiopianDate, religion: Religion = "christian"): Holiday[] {
  const out: Holiday[] = [];
...
export function gregorianHolidaysForDate(date: Date, religion: Religion = "christian"): Holiday[] {
