...
export default function CalendarPage() {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-4 md:gap-6">
      {/* Header */}
      <header className="glass rounded-2xl p-4 md:p-7">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="glass-subtle inline-flex rounded-full p-0.5">
            {modes.map((m) => (
              <button
                key={m}
      ...
      <div className="glass rounded-2xl p-3 md:p-6">
        <div className="mb-3 md:mb-5 flex items-center justify-between">
          <button
            onClick={() => navigate(-1)}
            className="flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground transition-all hover:bg-white/10 hover:text-foreground"
