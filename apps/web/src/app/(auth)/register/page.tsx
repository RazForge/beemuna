...
export default function RegisterPage() {
  ...
  const PERSPECTIVES = [
    { value: "muslim", label: "Muslim", hint: "Guidance from an Islamic perspective when relevant" },
    { value: "christian", label: "Christian", hint: "Guidance from a Christian perspective when relevant" },
    { value: "non-religious", label: "Non-religious", hint: "Neutral, secular guidance without religious framing" },
  ];
