...
def list_all_achievements(
    ...
    """List ALL possible achievements with unlock status for this user."""
    from app.services.journey_service import ACHIEVEMENT_DEFS, _compute_stats
    ...
    for defn in ACHIEVEMENT_DEFS:
        is_unlocked = defn["name"] in unlocked
        a = unlocked.get(defn["name"])
        all_achievements.append({
            ...
            "seen": a.seen if a else False,
        })

    total_points = sum(a.points for a in unlocked.values())
